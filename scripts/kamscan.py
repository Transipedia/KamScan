...
# Load covariates only if a TSV file is provided
if args.covariates != "no":
    if args.covariates.endswith(".tsv"):
        ...
        raise ValueError("Covariates file must be a .csv file.")
else:
    covariates_df = None
# ......................................................
#
...
condition_files = [file for file in condition_files]
...
for condition_file in condition_files:
    ...
    if args.test_type == 'pitest':
        ...
        for chunk_results in result:
            print(chunk_results)
            top_tags.extend([(variance_value, cv_value, tag_values) for variance_value, cv_value, tag_values in chunk_results])
    ...
    with open(output_file, 'w') as file:
        ...
        if args.test_type == 'ttest' or args.test_type == 'anova' or args.test_type == 'wilcoxon':
            ...
            for variance_value, cv_value, values in top_tags:
                output_data.append([values, variance_value, cv_value])
